...
'''
from movement.computer_players.policies.random_policy import RandomPolicy # Non agent policy thus pass policy directly
from movement.computer_players.agents.rl_dumb_agent import RLDumbAgent
